...
{
    public partial class relControleTemperatura : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            repControleTemperatura masterReport = null;

            foreach (var item in items)
            {
                var objReport = new repControleTemperatura();
            ...
            if (masterReport != null)
            {
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    WriteDocumentToResponse(ms.ToArray(), "pdf", true, "ControleTemperatura.pdf");
                }
            }
